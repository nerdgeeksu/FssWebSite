...
$lang['MENU_FORMATION_SM1'] = toUtf('Etudes Préparatoires'); //toHtml('Etudes Préparatoires');
...
//Footer
$lang['COPYRIGHT'] = utf8_encode('Copyright Heavenerd Inc 2015 Tous droits reservés');
